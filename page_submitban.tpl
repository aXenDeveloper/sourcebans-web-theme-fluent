        ...
        <div class="padding">
            <ul class="layout_box_medium_ul">
                    ...
                    <form action="index.php?p=submit" method="post" enctype="multipart/form-data">
                        ...
                        <ul class="layout_box_medium_ul">
                            <li>
                                ...
                                <select id="Type" name="Type" class="input input-full margin-top:half" onChange="changeType(this[this.selectedIndex].value);">
                            ...
                            <li>
                                ...
                                <input type="text" id="SteamID" name="SteamID" size="40" maxlength="64" value="{$STEAMID}" class="input input-full margin-top:half" />
                            </li>
                            <li>
                                <label for="BanIP">Players IP</label>
                                <input type="text" id="BanIP" name="BanIP" size="40" maxlength="64" value="{$ban_ip}" class="input input-full margin-top:half" />
                            </li>
                            <li>
                                <label for="PlayerName">Players Nickname <span class="mandatory">*</span></label>
                                <input type="text" id="PlayerName" size="40" maxlength="70" name="PlayerName" value="{$player_name}" class="input input-full margin-top:half" />
                            </li>
                            <li>
                                <label for="BanReason">Comments <span class="mandatory">*</span> (Please write down a descriptive comment. So NO comments like: "hacking")</label>
                                <textarea id="BanReason" name="BanReason" class="input input-full input_textarea margin-top:half">{$ban_reason}</textarea>
                            </li>
                            <li>
                                <label for="SubmitName">Your Name</label>
                                <input type="text" id="SubmitName" size="40" maxlength="70" name="SubmitName" value="{$subplayer_name}" class="input input-full margin-top:half" />
                            </li>
                            <li>
                                <label for="EmailAddr">Your Email <span class="mandatory">*</span></label>
                                <input type="text" id="SubmitName" size="40" maxlength="70" name="EmailAddr" value="{$player_email}" class="input input-full margin-top:half" />
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <input name="demo_file" id="demo_file" type="file" size="25" class="input input-full margin-top:half" />
                                <span>Note: Only DEM, ZIP, RAR, 7Z, BZ2 or GZ allowed.</span>
                            </li>


                            <li>
                                <button type="submit" name="save" class="button button:primary" onmouseover="ButtonOver(&quot;save&quot;)" onmouseout="ButtonOver(&quot;save&quot;)" id="save" value="Submit">Submit</button>
                            </li>
                        </ul>
                    </form>
                </li>
                ...
                <li>
                    ...
                    <p>If someone you reported gets banned, the SteamID or IP will be included onto the ban on the main bans list and everytime they try to connect to any server they will be blocked from joining and it will be logged into our database.</p>
                </li>
            </ul>
        </div>
    </div>

<div id="dialog-placement" style="vertical-align:middle;display:none;opacity:0;text-align:center;margin:0 auto;position:fixed !important;position:absolute;overflow:hidden;top:10px;left:50%;transform: translateX(-50%);z-index: 9999;">
    <div class="layout_box padding">

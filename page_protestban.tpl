    ...
    <div class="layout_box layout_box_medium">
        ...
        <div class="padding">
            <ul class="layout_box_medium_ul">
                <li>
                    In order to appeal a ban, you must make sure you are banned via clicking <a
                        href="index.php?p=banlist" class="text:bold">here</a> to see if you are banned and for what
                    reason.
                </li>
                <li>
                        ...
                        <ul class="layout_box_medium_ul">
                            ...
                            <li id="steam.row">
                                ...
                                <input type="text" id="SteamID" name="SteamID" size="40" maxlength="64"
                                    value="{$steam_id}" class="input input-full margin-top:half" />
                            </li>
                            ...
                            <li>
                                <label for="BanReason">Reason why you should be unbanned <span
                                        class="mandatory">*</span>: (Be as descriptive as possible)</label>
                                <textarea id="BanReason" name="BanReason" cols="30" rows="5"
                                    class="input input_textarea margin-top:half">{$reason}</textarea>
                            </li>
                            <li>
                                <label for="EmailAddr">Your Email <span class="mandatory">*</span></label>
                                <input type="text" id="EmailAddr" size="40" maxlength="70" name="EmailAddr"
                ...
                <li>
                    ...
                    <p>The staff team will be notified of your appeal. They will then review if the ban is conclusive.
                        After reviewing you will get a reply, which usally means within 24 hours.</p>

                    <h3>Note:</h3>
                    <p>Sending emails with threats to our admins, scolding or shouting will not get you unbanned and you
                        will be permanently denied from using any of our services.</p>
                </li>
            </ul>
        </div>
    </div>

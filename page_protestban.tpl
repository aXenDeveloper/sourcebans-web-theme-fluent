                    ...
                    <form action="index.php?p=protest" method="post">
                        ...
                        <ul class="layout_box_medium_ul">
                            ...
                            <li id="steam.row">
                                ...
                                <input type="text" id="SteamID" name="SteamID" size="40" maxlength="64" value="{$steam_id}" class="input input-full margin-top:half" />
                            </li>
                            <li id="ip.row" style="display: none;">
                                <label for="Ip">Your IP</label>
                                <input type="text" id="Ip" name="IP" size="40" maxlength="64" value="{$ip}" class="input input-full" />
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <input type="text" id="EmailAddr" size="40" maxlength="70" name="EmailAddr" value="{$player_email}" class="input input-full margin-top:half" />
                            </li>
                            <li>

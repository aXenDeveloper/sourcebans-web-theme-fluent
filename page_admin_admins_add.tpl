            ...
            <div id="add-group">
                ...
                <form class="form">
                    ...
                    <div class="margin-bottom:half">
                        ...
                        <input type="text" TABINDEX=2 value="STEAM_0:" class="form-input form-full" id="steam"
                            name="steam" />
                    ...
                    <div class="margin-bottom:half">
                        ...
                        <div class="flex margin-top:half">
                            <button id="password_generate"
                                class="button button-light button:line flex:11 margin-right:half">
                    ...
                    <div class="margin-bottom:half">
                        ...
                        <ul class="list-reset">
                            ...
                            {foreach from="$group_list" item="group"}
                                <li class="margin-bottom:half">
                                    <input type="checkbox" id="group[{$group.gid}]" class="form-check" name="group[]"
                                        value="g{$group.gid}" />
